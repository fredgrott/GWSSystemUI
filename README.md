...
This is borrowed from Chris Banes' gist posting.
...
```groovy
compile 'com.github.shareme:GWSSystemUI:{latest-release-number}@aar'
```
...
Android Target API Range
========================

Android api level 16 to 23. the library will be depreciated after we fully move to the 22 and up api
ranges.
...
[Chris Banes gist post](https://gist.github.com/chrisbanes/73de18faffca571f7292)
